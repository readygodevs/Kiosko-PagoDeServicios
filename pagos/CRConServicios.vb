...
Public Class CRConServicios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "pagos.CRConServicios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRConServicios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRConServicios = New CRConServicios()
        rpt.Site = Me.Site
        Return rpt
    End Function
